...
def Get_Histogram():
    ...
    print("Trailer   ", trailer_c, ":", asterisk_t)
...
while True:
    ...
    final_say.append(output + ' - ' +  ', '.join(map(str, marks)))
    ...
    if flow == "y":
        ...
        Get_Histogram() # Calling out to get the Histogram
        break

for i in final_say:
        print(i)    # Printing the marks in list order

Get_Text_File() # Call out to get text file
